...
\bottomline
\endlastfoot
4.01.00  &  - Highligthed line contains dots at time-points.\\
...
\begin{figure}[H]
    ...
    \caption{Opening window of the program PlotCFTS (\textbf{Plot} \textbf{C}limate and \textbf{F}orecast \textbf{T}ime \textbf{S}eries)}
\end{figure}
