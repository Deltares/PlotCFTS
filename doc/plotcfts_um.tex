...
A tooltip with text from the comment-attribute will appear in the parameter listbox, if the comment-attribute was added to the variable.
...
%--------------------------------------------------------------------------------
\subsection{Combobox next to text \button{Add to Plot:}}
With this combobox you are able to select a plot by its number in which an additional graph can be plotted.

%--------------------------------------------------------------------------------
\subsection{Button \button{Add to Plot}}
When pressing this button the graph of the selected Parameter--Location will be added to the selected plot, indicated by the plot number.
...
\begin{longtable}{p{17mm-12pt}|p{\textwidth-17mm-12pt}}
    ...
    \bottomline
    \endlastfoot
    4.06.00  &  -  Tooltip added on the items of the parameter listbox, supplied by the comment-attribute of a variable.\\
    4.05.02  &  -  Upgrade to QT 6.10.3.\\
    4.05.01  &  -  Upgrade to QT 6.10.2.\\
